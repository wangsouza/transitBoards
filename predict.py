...
with model.as_default():
    with tf.Session(graph=model) as sess:
        ...
        # OBS: Essas referências nos permitirão acessar seus valores associados
        # depois de passar a imagem pela rede
        ...
        # Prepara a imagem para detecção
        (H, W) = image.shape[:2]
        output = image.copy()
        ...
        # caixa delimitadora, scores (probabilidades), rótulos de classe e o
        # número de tensores de detecção para o método sess.run.
        # O feed_dict instrui o TensorFlow a definir o imageTensor como a nossa
        # imagem e executar um forward-pass, produzindo nossas caixas
        ...
        # Achatar as listas em uma única dimensão. As caixas, pontuações e
        # etiquetas são todas matrizes multidimensionais, então as comprimimos
        # em uma matriz 1D, permitindo que passemos facilmente sobre elas.
        ...
        for (box, score, label) in zip(boxes, scores, labels):
            ...
            # Escalona a caixa delimitadora a partir do intervalo [0, 1] para
            # [W, H], ou seja, caminho inverso de quando foi feito o
            # treinamento.
            ...
            # Executa o rótulo legível por humanos no dicionário categoryIdx e
            # desenham o rótulo e a probabilidade associada a imagem.
